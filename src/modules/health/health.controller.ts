...
export class HealthController {
  constructor(
    ...
    private etlDirIndicator: EtlDirHealthIndicator,
  ...
  @Get()
  @HealthCheck()
  @ApiOperation({ summary: 'Check API health status (database, SQL Server, memory, ETL dirs)' })
  ...
  check() {
    return this.health.check([
      ...
      () => this.etlDirIndicator.isHealthy('etl_dirs'),
